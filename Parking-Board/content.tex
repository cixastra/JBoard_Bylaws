...
\begin{enumerate}
    \item The Parking Board is a subordinate judicial body of the Judicial Board, established under the authority of the President of the Institute and the Rensselaer Union to adjudicate appeals related to parking citations.
    \item The Director of Auxiliary Services, or their authorized designee, is required to facilitate this appellate process and must provide administrative representation as specified in these bylaws.
    \item A contestation of a parking ticket does not constitute an appeal; however, all parking citations maintain the inherent right to come before this Board for a formal appeal.
    \item The Parking Board explicitly recognizes the superior authority of the Institute Hearing Procedures.
    \item Judgments rendered by the Parking Board must follow Institute Hearing Procedures and shall be adhered to by the administration as final agency actions.
...
\begin{enumerate}
    \item The Parking Board is an ad hoc committee that remains omnipresent in its authority but is fully formed only when notified of a pending case by the Director of Auxiliary Services or their designee.
    ...
    \begin{enumerate}
        ...
        \item Two (2) administrators appointed by the Director of Auxiliary Services or their designee.
    \end{enumerate}
...
\begin{enumerate}
    \item In the event that the Director of Auxiliary Services fails to fulfill the requirement to appoint administrative representatives, the responsibility to ensure a full panel falls to the Parking Board Chairperson to prevent a denial of due process.
...
\begin{enumerate}
    ...
    \item If an administrative appointee is conflicted, the Director of Auxiliary Services must provide a new appointee or serve on the panel themselves.
\end{enumerate}
...
\JBArticle{pb-article-7}{Article VII: Amendments}
\begin{enumerate}
    \item Amendments to these bylaws must be passed in accordance with the standard amendment procedures of the Judicial Board.
    \item Following approval by the Judicial Board, any amendments to the Parking Board bylaws must also be approved by the President of the Institute or their designee before taking effect.
\end{enumerate}